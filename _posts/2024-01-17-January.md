...
The community welcomes Lars Müller (aka Luatic, appguru(eu), LMD) ([Github](https://github.com/appgurueu), 
...
touchscreen and mouse modes at runtime, which will allow tablets with touch
screens or Android devices to switch between modes at will while playing.
...
to receive updates and become polished examples of what Minetest can do while
...
The Blockexchange project has undergone internal rewrites and enhancements that

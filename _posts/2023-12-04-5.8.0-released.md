...
We'll be improving the new user experience in the future, based on feedback. For
example, we've already started a ContentDB dialog ("Browse online content")
redesign to make it easier to find and choose packages.

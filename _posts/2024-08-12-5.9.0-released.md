...
In order to give modders and game developers full artistic control, Minetest lets mods control this feature.

Make sure that you have shaders enabled, are using a compatible antialiasing setting, and have bloom and volumetric lighting enabled in settings.

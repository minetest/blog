...
description: >
This month, we cover several engine improvements, Backrooms Test's first 
release, and more. We also commemorate the sad passing of a valued 
Minetest team member.
...
We are sad to report that TurkeyMcMac, a recently-added and valued core team
member, passed away in early February. [See his family's memorial forum
post.](https://forum.minetest.net/viewtopic.php?f=18&t=29161)

In December, he submitted a
[prototype](https://github.com/minetest/minetest/pull/13046) for a new
client-side scripting API. The Minetest team hopes to adopt and continue to
develop it. It aims to replace the current client-side modding API and will
allow games and mods to run scripts on the client in a new sandboxed process.

Thank you for this and for everything else you did for us, TurkeyMcMac. Rest in
peace.
...
no tasks to do. There are simply huge, near-infinite expanses filled with
...
caverns with custom-painted textures. It creates both a sense of dicovery and of
...
[Phii](https://content.minetest.net/users/Phii/) released a procedual dungeon
...
custom mods, etc. For teachers, educators and workshop facilitators, learning
everything can be a complicated and time consuming task.

...
{% include figure.html src="/static/blog/2024_TopOfYear/Mortuary_Temple_of_Ramesses_III_at_Medinet_Habu.png" caption='"Egyptian Temple" by jdiego, built using references of the Mortuary Temple of Ramesses III at Medinet Habu' %}
{% include figure_gallery.html items=page.gallery_temple_details %}

{% include figure.html src="/static/blog/2024_TopOfYear/colorland.png" caption='"Colorlandia server spawn" by dibesfer' %}

{% include figure.html src="/static/blog/2024_TopOfYear/digilines_comp.png" caption='"Ventilated computer with several commands executed on its large screen" by Bituvo, find on sever "Eden Lost" at station "Computer" under travelent "Thresher" at spawn' %}

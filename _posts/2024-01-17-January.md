...
The Blockexchange project has undergone internal rewrites and enhancements which improve the overall usability, such as logging in with ContentDB, featured schematics on the homepage, better schematic detail pages with CDB collections and markdown support, and a new UI with faster response times. Check out the new features here: https://blockexchange.minetest.ch/

...
Minetest 5.6.0 has been released with dynamic shadows, improvements to
the "Select Mods" and "login"/"register" user interfaces (UIs), and more!
...
disables those mods. This is now deprecated, and, in the furture, worlds will
instead fail to load. This improves user experience, since players are often

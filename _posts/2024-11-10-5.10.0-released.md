...
* **IPC**: The new [IPC API](https://github.com/minetest/minetest/blob/5.10.0/doc/lua_api.md#ipc) allows Luanti server
  Lua environments to freely share data between all environments (server, async, and mapgen) via a key-value store,
  making async and mapgen environments more powerful and easier to use.
